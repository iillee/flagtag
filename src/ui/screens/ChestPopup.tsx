...
export function ChestPopup() {
  ...
  return (
    ...
    >
      <UiEntity uiTransform={{
        width: mobile ? 480 : S(540),
        flexDirection: 'column',
        alignItems: 'center',
        padding: mobile
          ? { top: 28, bottom: 28, left: 28, right: 28 }
          : { top: S(28), bottom: S(28), left: S(28), right: S(28) },
      ...
      >
        ...
        <Label value="Chest" fontSize={mobile ? 38 : S(32)} color={GOLD} font="sans-serif" uiTransform={{ margin: { bottom: mobile ? 6 : S(6) } }} />
        ...
        <UiEntity uiTransform={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
          {BOOMERANG_STORE.map((item) => {
            ...
            const cardWidth = mobile ? 120 : S(140)
            const cardHeight = mobile ? 230 : S(270)
            ...
            return (
              ...
              >
                <UiEntity
                  uiTransform={{ width: mobile ? 86 : S(100), height: mobile ? 86 : S(100), margin: { top: mobile ? 6 : S(8) } }}
                ...
                />
                <Label value={item.label} fontSize={mobile ? 20 : S(18)} color={selected ? GOLD : owned ? LIGHT_GREY : GREY} uiTransform={{ margin: { top: mobile ? 4 : S(6) } }} />
        ...
        {buyError ? (
          <Label value={buyError} fontSize={mobile ? 17 : S(14)} color={CORAL_RED} uiTransform={{ margin: { top: mobile ? 10 : S(10) } }} />
        ) : null}
      </UiEntity>
    </UiEntity>
  )
