...
let _blessingPreCheckDone = false
export function isBlessingPreCheckDone(): boolean { return _blessingPreCheckDone }
export function setBlessingPreCheckDone(v: boolean) { _blessingPreCheckDone = v }
